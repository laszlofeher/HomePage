            ...
            <section id="blog" class="block-section">
                <div class=" shape-bottom">
                    <div class="bg-secondary block-title">
                        <div class="container">
                            <h2 class="text-uppercase color-dark text-bold no-margin"><?php if (isset($tutorialdetail['title'])) {
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="blog-content">
                                    <img src="<?php print(base_url()) ?>assets/theme/images/blog/<?php print($tutorialdetail["picturepath"] ?? '1.jpg'); ?>"" alt="" class="img-responsive">
                                    <div class="white-space-20"></div>
                                    <div class="post-meta font-alt">
                                        <span><i class="fa fa-calendar"></i><?php if (isset($tutorialdetail['publicday'])) {
                print($tutorialdetail['publicday']);
            } else {
                print('dátum');
            } ?></span>
...
<?php if (isset($tutorialdetail['blogcontent'])) {
    print($tutorialdetail['blogcontent']);
} else {
    print('tartalom');
} ?>
                                </div>
...
?>
                                ...
                                <form method="POST">
                                    <div class="row">
                                        <div class="col-md-4 ">
                                            <input type="hidden" value="<?php print($tutorialentryid); ?>" name="blogentryid" />
...
<?php
foreach ($tutorialtags as $key => $value) {
    ?>
                                            <li><a href="<?php print(base_url('blog/bloglistbypopulartag/' . $value['normalizedtagname'] . '/0')); ?>"><?php print($value['tagname'] . ' ' . ' (' . $value['count'] . ')'); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    </ul>
