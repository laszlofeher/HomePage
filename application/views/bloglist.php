      ...
      <section id="blog" class="block-section">
        ...
        <div class=" shape-bottom">
          <div class="bg-secondary block-title">
            <div class="container">
              <h2 class="text-uppercase color-dark text-bold no-margin">BLOGOM</h2>
                ...
                ?>  
                            <li>
                              <div class="clearfix box-blog">
                                <div class="blog-bg" data-holdbg="<?php print(base_url())?>assets/theme/images/blog/<?php print($blog[$i]["picturepath"] ?? '1.jpg'); ?>">&nbsp;
