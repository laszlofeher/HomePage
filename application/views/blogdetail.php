            ...
            <section id="blog" class="block-section">
                <div class=" shape-bottom">
                    <div class="bg-secondary block-title">
                        <div class="container">
                            <h2 class="text-uppercase color-dark text-bold no-margin"><?php if (isset($blogdetail['title'])) {
                print($blogdetail['title']);
            } else {
                print('Blog cím');
            } ?></h2>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="blog-content">
                                    <img src="<?php print(base_url()) ?>assets/theme/images/blog/<?php print($blogdetail["picturepath"] ?? '1.jpg'); ?>"" alt="" class="img-responsive">
                                    <div class="white-space-20"></div>
                                    <div class="post-meta font-alt">
                                        <span><i class="fa fa-calendar"></i><?php if (isset($blogdetail['publicday'])) {
                print($blogdetail['publicday']);
            } else {
                print('dátum');
            } ?></span>
...
<?php if (isset($blogdetail['blogcontent'])) {
    print($blogdetail['blogcontent']);
} else {
    print('tartalom');
} ?>
                                </div>
